...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ route('admin.index') }}" class="logo">
            ...
            <span class="logo-mini"><b></b>{{ auth()->user()->first_name }}</span>
            <span class="logo-lg"><b>Welcome : </b>{{ auth()->user()->first_name }} </span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown tasks-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="label label-success">{{ trans('site.lang') }}</span>
                        </a>
...
{{--                                    {{ auth()->user()->first_name }} {{ auth()->user()->last_name }}--}}
                                    ...
                                    <small><br>Member since 2 days</small>
                                </p>
                            </li>
    ...
    <footer class="main-footer">
        ...
        <strong>@lang('site.Copyright-&copy;-2019-2020')
            <a href="">@lang('site.Almsaeed_Studio')</a>.</strong>
    </footer>
...
{{--Custom  A new File Called Order.js--}}
