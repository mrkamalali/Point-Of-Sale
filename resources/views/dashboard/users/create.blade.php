                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-lg-6 has-img">
                            ...
                            <img src="{{ asset('uploads/users_images/default.png') }}" style="width: 100px" class="img-thumbnail image-preview img-circle " alt="">
                        </div>
                                    ...
                                    @foreach($models as $index=>$model)
                                        <div class="tab-pane {{ $index == 0 ? 'active' : '' }}" id="{{ $model }}">
                                            ...
                                            @foreach($permissions as $permission)
                                                <label><input style="margin-left: 4px" type="checkbox" name="permissions[]"
